...
<header>
    ...
    <form id="form-update" method="POST" action="<?= base_url('index.php/admin_control/dataUpdate'); ?>">
        ...
        <?php elseif ($this->session->userdata('admin_page_location') === 'user') : ?> <label for="nama_lengkap">Nama Lengkap</label>
            ...
            <input id="tanggal_lahir" name="tanggal_lahir" type="date" value="<?= $user['tanggal_lahir']; ?>" required>
        ...
        <?php elseif ($this->session->userdata('admin_page_location') === 'transaksi') : ?> <label for="kode_pemesanan">kode_pemesanan</label>
